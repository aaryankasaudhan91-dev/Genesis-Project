...
import AboutCreators from './components/AboutCreators'; // Import new component
...
const App: React.FC = () => {
  ...
  const [view, setView] = useState<'LOGIN' | 'DASHBOARD' | 'PROFILE' | 'SETTINGS' | 'CONTACT' | 'HELP' | 'ADD_DONATION' | 'ABOUT'>('LOGIN');
